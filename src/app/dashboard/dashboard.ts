...
import { Deslizar } from '../Componentes-animacoes/deslizar/deslizar';

@Component({
  selector: 'app-dashboard',
  standalone:true,
  imports: [Menu, Localizacao, Contador, Header, ParticipacaoGlobal, ProvinciaInfluencia, ResumoPorProvincia, Deslizar],
